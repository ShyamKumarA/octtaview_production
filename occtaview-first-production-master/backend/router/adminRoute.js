...
import {
  ...
  rejectCapitalwithdrawal,
  rejectUser,
  rejectWalletWithdrawal,
  userPackageApproval,
  userPackageReject,
  viewAddFundPending,
  viewAddPackageFundPending,
  viewAllUsers,
  viewUserDetails,
  viewWalletWithdrawPending,
  viewWithdrawPending,
  totalCapitalWithdrawHistory,
...
adminRouter.post("/reject-users/:id", protectUser, rejectUser);
adminRouter.post("/approve-addFund/:id", protectUser, approveFundAdd);
adminRouter.post(
  "/user-package-approval/:id",
  protectUser,
  userPackageApproval
);
adminRouter.post("/user-package-rejected/:id", protectUser, userPackageReject);
adminRouter.post(
  "/user-capitalWithdraw-approval/:id",
  protectUser,
  approveCapitalwithdrawal
);
adminRouter.post(
  "/user-capitalWithdraw-reject/:id",
  protectUser,
  rejectCapitalwithdrawal
);
adminRouter.post(
  "/user-walletWithdraw-approval/:id",
  protectUser,
  approveWalletWithdrawal
);
adminRouter.post(
  "/user-walletWithdraw-reject/:id",
  protectUser,
  rejectWalletWithdrawal
);
...
adminRouter.get(
  "/view-users-capitalWithdrawHistory",
  protectUser,
  totalCapitalWithdrawHistory
);
adminRouter.get(
  "/view-users-walletWithdrawHistory",
  protectUser,
  totalWalletWithdrawHistory
);
